class QuestionPaser:
    ...
    def build_entitydict(self, args):
        """
        input an question:二硫化碳中毒的症状是什么？
        {'args': {'二硫化碳中毒': ['disease']}, 'question_types': ['disease_symptom']}
        :param args:
        :return:
        """
        entity_dict = {}
...
if __name__ == '__main__':
    args = {'args': {'二硫化碳中毒': ['disease']}, 'question_types': ['disease_symptom']}
    handler = QuestionPaser()
    # handler.build_entitydict(args['args'])
